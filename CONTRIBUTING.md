...
The xcube-eopf welcomes contributions of any form
...
* Make sure test coverage stays close to 100% for any change.
  Use `pytest --cov=xcube_eopf --cov-report=html` to verify.
...
The code style of xcube-eopf equals the default settings 
...
3. 1st-party library module imports using absolute paths, 
   e.g., `from xcube_eopf.a.b.c import d`. 
